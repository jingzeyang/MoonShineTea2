 ...
 *
 * {@sample
frameworks/support/samples/Support4Demos/src/com/example/android/supportv4/app/FragmentTab
s.java
 *      complete}
 *
...
public class NewsFragmentTabHost extends TabHost
    ...
    public void addTab(@NonNull TabSpec tabSpec, @NonNull Class<?> clss,
        ...
        final NewsFragmentTabHost.TabInfo info = new NewsFragmentTabHost.TabInfo(tag,
                clss, args);
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        NewsFragmentTabHost.SavedState ss = new NewsFragmentTabHost.SavedState
                (superState);
